<div x-data="{ isSearchOpen: false }">
    <!-- Tombol Search -->
    <div id="open-search" @click="isSearchOpen = true"
    ...
    <!-- Modal Search -->
    <div id="search-modal" x-show="isSearchOpen" @click.away="isSearchOpen = false"
        ...
        <div class="bg-white w-[90%] md:w-[600px] p-5 rounded-lg shadow-lg max-h-[70vh] overflow-hidden flex flex-col">
            ...
            <!-- Load More Button -->
            <button class="w-full mt-3 py-2 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-600">
                Load More
            </button>
        </div>
    </div>
