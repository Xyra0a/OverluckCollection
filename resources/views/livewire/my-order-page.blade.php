            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              ...
              <tbody>
                ...
                <tr class="odd:bg-white even:bg-gray-100 dark:odd:bg-slate-900 dark:even:bg-slate-800">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-800 dark:text-gray-200"><span class="bg-green-500 py-1 px-3 rounded text-white shadow">{{ $order->payment_type ?? 'N/A' }}</span></td>
