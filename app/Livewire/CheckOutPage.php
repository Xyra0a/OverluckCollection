...
class CheckOutPage extends Component
{
    ...
    public function render()
    {
        ...
        // Loop untuk menyimpan semua produk dari cart ke tabel order_items
        foreach ($this->items as $item) {
            $productId = $item['product_id']; // Ambil product_id dari cart
            $product = Product::find($productId);
            ...
            // Simpan produk ke dalam tabel order_items
            OrderItem::create([
                'order_id' => $order->id,
                ...
                // 'quantity' => $item['quantity'], // Pastikan ada jumlah produk di cart
